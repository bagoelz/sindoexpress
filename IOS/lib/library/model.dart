...
class DataResi {
  ...
  String get namaPenerima => penerima;
...
class DataKapal {
  int id, enabled;
  String name;
  DataKapal({this.id, this.enabled, this.name});
...
class DataGallery {
  ...
  DataGallery({this.id, this.picture, this.caption});
...
class DataNotif {
  String id, kode, judul, tglNotif, tgl, tglbaca, modul;
  DataNotif({
    this.id,
    this.kode,
    this.judul,
  ...
  DataNotif.map(dynamic data) {
    this.id = data['id'];
    this.kode = data['kd_sub'];
    this.judul = data['judul'];
    this.tglNotif = data['tgl_notif'];
    this.tgl = data['tgl'];
    this.tglbaca = data['tgl_baca'];
