...
class RestDatasource {
  ...
  String baseUrl = 'https://sindo.co.id/apk/tracking.php?key=s3ks9293ks9&tally=';
  String baseUrlNotif = 'https://sindo.co.id/apk/notif.php?key=s3ks9293ks9';
  String baseUrljadwal = 'http://www.sindo.co.id/apk/jadwal.php?key=s3ks9293ks9&tgl_est1=';
