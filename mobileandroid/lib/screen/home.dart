...
import 'package:sindoexpress/screen/newsDetail.dart';
...
class _homeState extends State<home> {
  ...
  getFcm() async {
    _firebaseMessaging.configure(
      onMessage: (Map<String, dynamic> message) async {
        if (message['data']['keyname'] == 'berita') {
          setState(() {
            flagberita = true;
          });
        } else if (message['data']['keyname'] == 'jadwal') {
          setState(() {
            flagjadwal = true;
          });
        } else {
  ...
  Future<void> _showPublicNotification({id, judul, pesan}) async {
    var vibrationPattern = Int64List(4);
    var androidPlatformChannelSpecifics = AndroidNotificationDetails(
        id.toString(), 'Sindoexpress', 'Sindoexpress notifikasi',
    ...
    await flutterLocalNotificationsPlugin.show(
        0, judul, pesan, platformChannelSpecifics,
        payload: id.toString());
  }
