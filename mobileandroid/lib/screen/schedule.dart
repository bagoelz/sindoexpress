                      ...
                      child: Container(
                              ...
                              child:Column(
                                children: List.generate(jadwal.length, (index){
                                  return jadwal[index]['ship'].length > 1 ? Column(
                                    children: <Widget>[
                                    //   Container(
                                              ...
                                              child:Column(
                                                children: <Widget>[
                                                  Container(
                                                   ...
                                                   Container(
                                                    width: 20,
                                                    height: jadwal[index]['ship'].length > 1 ? 80.0 * (jadwal[index]['ship'].length.toDouble()): 80.0 ,
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: <Widget>[
                                                              Container(
                                                                ...
                                                                child: Text('CLOSE DATE ',style: TextStyle(color: Colors.black, fontSize: 11,fontFamily: 'Montserrat',fontWeight: FontWeight.w700),),
                                                              ),
                                                              Container(
                                                                width: MediaQuery.of(context).size.width/4.5,
