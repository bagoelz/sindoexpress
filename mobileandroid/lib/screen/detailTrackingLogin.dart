...
class trackingDetailLogin extends StatefulWidget {
  DataResi dataTracking;
  final bool login;
  trackingDetailLogin({Key ket, this.login: false, this.dataTracking});
  @override
  _trackingDetailLoginState createState() => _trackingDetailLoginState();
}

class _trackingDetailLoginState extends State<trackingDetailLogin> {
